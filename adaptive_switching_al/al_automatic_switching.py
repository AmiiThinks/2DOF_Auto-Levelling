...
robotObj[2].pmin = wristRot_pmin - buffer
robotObj[2].pmax = wirstRot_pmax + buffer
robotObj[2].vmin = 1024 - (wristRot_v + buffer)
robotObj[2].vmax = 1024 + (wristRot_v + buffer)
robotObj[2].loadmin = 1024 - (250 + buffer)
robotObj[2].loadmax = 1024 + (250 + buffer)
robotObj[2].maxtemp = 80 + buffer
robotObj[3].pmin = wristFlex_pmin - buffer
robotObj[3].pmax = wristFlex_pmax + buffer
robotObj[3].vmin = 1024 - (wristFlex_v + buffer)
robotObj[3].vmax = 1024 + (wristFlex_v + buffer)
robotObj[3].loadmin = 1024 - (300 + buffer) 
robotObj[3].loadmax = 1024 + (300 + buffer)
robotObj[3].maxtemp = 80 + buffer
robotObj[4].pmin = hand_pmin - buffer
robotObj[4].pmax = hand_pmax + buffer
robotObj[4].vmin = 1024 - (hand_v + buffer)
robotObj[4].vmax = 1024 + (hand_v + buffer)
    ...
    while True:
        ...
        while True:
            ...
            for i in range(3,packetRX[2], N):
                ...
                robotObj[packetRX[index_counter]-1].update_zoomed_norm(packetRX[index_counter+1],packetRX[index_counter+2],packetRX[index_counter+3],packetRX[index_counter+4],packetRX[index_counter+5],packetRX[index_counter+6])
        ...
        if UDP_flag == 1:
            ...
            list_wristRot_state.append(robotObj[2].normalized_state)
            list_wristRot_pred.append(normalized_pred[0])
            list_wristFlex_state.append(robotObj[3].normalized_state)
            list_wristFlex_pred.append(normalized_pred[1])
            list_hand_state.append(robotObj[4].normalized_state)
            list_hand_pred.append(normalized_pred[2])
